 ...
 */
final class Version20220208180140 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE classroom DROP PRIMARY KEY');
        $this->addSql('ALTER TABLE classroom CHANGE ref id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE classroom DROP PRIMARY KEY');
        $this->addSql('ALTER TABLE classroom CHANGE id ref INT NOT NULL');
